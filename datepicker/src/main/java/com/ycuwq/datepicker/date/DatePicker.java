...
public class DatePicker extends LinearLayout implements YearPicker.OnYearSelectedListener,
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        boolean dayEnabled = a.getBoolean(R.styleable.DatePicker_dayEnabled, true);
        boolean monthEnabled = a.getBoolean(R.styleable.DatePicker_monthEnabled, true);
        boolean yearEnabled = a.getBoolean(R.styleable.DatePicker_yearEnabled, true);
        a.recycle();
        ...
        setMonthEnabled(monthEnabled);
        setYearEnabled(yearEnabled);
    }
    ...
    public void setDayEnabled(boolean enabled) {
        mDayPicker.setDayEnabled(enabled);
    }

    public void setMonthEnabled(boolean enabled) {
        mMonthPicker.setMonthEnabled(enabled);
    }

    public void setYearEnabled(boolean enabled) {
        mYearPicker.setYearEnabled(enabled);
    }
