...
public class WheelPicker<T> extends View {
    ...
    private int mSelectedItemTextColorDisabled;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mSelectedItemTextColorDisabled = a.getColor(R.styleable.WheelPicker_selectedTextColor, Color.parseColor("#9098B1"));
        ...
        mIndicatorTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_indicatorTextSize, mTextSize);
        mEnabled = a.getBoolean(R.styleable.WheelPicker_android_enabled, true);
        setEnabled(mEnabled);
        a.recycle();
    }
    ...
    private void initPaint() {
        ...
        if (mEnabled)
            ...
            mSelectedItemPaint.setColor(mSelectedItemTextColorDisabled);
